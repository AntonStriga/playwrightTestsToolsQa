...
import { TEXT_BOX_LABELS } from '../../testData/textBoxData.js'
...
export class TextBoxPage {
    ...
    constructor(page: Page) {
        this.title = page.getByRole('heading', { name: TEXT_BOX_LABELS.title })
        ...
        this.submitButton = this.userForm.getByRole('button', { name: TEXT_BOX_LABELS.submitButton })
